defmodule Cldr.Test do
  ...
  test "that we have the right number of rbnf locales" do
    assert Cldr.known_rbnf_locale_names() ==
      ["af", "ak", "am", "ar", "az", "be", "bg", "bs", "ca", "ccp", "chr", "cs", "cy",
       "da", "de", "de-CH", "ee", "el", "en", "en-IN", "eo", "es", "es-419", "et",
       "fa", "fa-AF", "ff", "fi", "fil", "fo", "fr", "fr-BE", "fr-CH", "ga", "he",
       "hi", "hr", "hu", "hy", "id", "is", "it", "ja", "ka", "kl", "km", "ko", "ky",
       "lb", "lo", "lrc", "lt", "lv", "mk", "ms", "mt", "my", "nb", "nl", "nn", "pl",
       "pt", "pt-PT", "qu", "ro", "root", "ru", "se", "sk", "sl", "sq", "sr",
       "sr-Latn", "sv", "sw", "ta", "th", "tr", "uk", "vi", "yue-Hans", "zh",
       "zh-Hant"]
  end
